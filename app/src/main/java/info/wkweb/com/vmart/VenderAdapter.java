...
public class VenderAdapter extends RecyclerView.Adapter<VenderAdapter.ViewHolder>
{
    ...
    public VenderAdapter(JSONArray listdata , Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      //  final VenderData myListData = listdata[position];
    ...
    public class Communication_addcart extends AsyncTask<String, Void, String> implements DialogInterface.OnCancelListener {
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (result !=null)
            {
                ...
                {
                    Intent intent2 = new Intent("cartcustomerupdatev");
